...
bot.on('message', message => {
  ...
  //   })
    ...
    const ls = exec('python ~/AI_ML/stable-diffusion/optimizedSD/optimized_txt2img.py --prompt "' + args.join(' ') + '" --outdir ~/FREDBot/outFolder --H 768 --W 768 --n_iter 2 --n_samples 3 --ddim_steps 50 --ckpt ~/AI_ML/stable-diffusion/models/ldm/stable-diffusion-1-5/v1-5-pruned.ckpt', (error, stdout, stderr) => {
      if (error) {
        console.log(error);
